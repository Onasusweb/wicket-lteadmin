 ...
 * under the License.
 */
package com.bustanil.myapp.shared.wicket.themes;
...
public class AdminLTE extends Theme {
    ...
    public List<HeaderItem> getDependencies() {
        ...
        references.add(CssHeaderItem.forReference(new CssResourceReference(AdminLTE.class, "css/skins/skin-blue.css")));
